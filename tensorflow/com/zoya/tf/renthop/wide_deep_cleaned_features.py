...
TRAIN_DF = 'input/featured_train_df.csv'
TEST_DF = 'input/featured_test_df.csv'

LABEL_COLUMN = "out"
LINEAR_CAT_COLUMNS = ['building_id', 'manager_id', 
                      'street_address','street_address_cleaned', 
                      'display_address', 'display_address_cleaned']
DNN_CONT_COLUMNS = ["building_id_dnn", "manager_id_dnn", "street_address_dnn", 
                    "display_address_dnn",
                    "listing_id", "manager_count", "manager_count_train",
                    ...
                    "photos_feature", "location", "had_unrealistic_price", 
                    ...
                    "mean_sub_bed_price1","price_sub_ratio1","mean_sub_bed_price05","price_sub_ratio05" ]

BAD_BEHAVING_COLUMNS = ['manager_count', 'listing_id', "manager_count_train"]
...
def main():
    ...
    classifier = tf.contrib.learn.DNNLinearCombinedClassifier(
        model_dir="wide_deep_cleaned145_50hu",
    ...
    out_df.to_csv("wide_deep_nn_clean.csv", index=False)
